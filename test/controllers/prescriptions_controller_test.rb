...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { cost: @prescription.cost, description: @prescription.description, doctorname: @prescription.doctorname, dose: @prescription.dose, firstname: @prescription.firstname, lastname: @prescription.lastname, medicine: @prescription.medicine, patient_id: @prescription.patient_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { cost: @prescription.cost, description: @prescription.description, doctorname: @prescription.doctorname, dose: @prescription.dose, firstname: @prescription.firstname, lastname: @prescription.lastname, medicine: @prescription.medicine, patient_id: @prescription.patient_id } }
